...
public class RS_song extends JPanel {
    ...
    public RS_song(String msg) {
        ...
        name.setOpaque(true);
        name.setFont(new Font("NPS font",Font.BOLD, 28)); // 글자체 효과 크기 지정
        ...
        info.setOpaque(true);
        info.setFont(new Font("NPS font",Font.BOLD, 18)); // 글자체 효과 크기 지정
